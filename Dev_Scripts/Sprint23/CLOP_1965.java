...
public class CLOP_1965 {
	...
	public void CLOP_1965_Test() throws Exception {
		...
		Assert.assertEquals("https://metadatadev.clo.edmesh.com/img/content-browser/cloitem.jpg", Chrome_Driver.findElement(By.xpath("html/body/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/a/img")).getAttribute("src"));
		...
		Chrome_Driver.findElement(By.xpath("//*[@type='submit']")).click();
		Assert.assertEquals("https://metadatadev.clo.edmesh.com/img/content-browser/permission-denied.png", Chrome_Driver.findElement(By.xpath("html/body/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/a/img")).getAttribute("src"));
		Chrome_Driver.findElement(By.xpath("//*[@href='/advancedsearch']")).click();
