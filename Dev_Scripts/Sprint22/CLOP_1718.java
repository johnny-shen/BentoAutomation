...
public class CLOP_1718 {
	...
	public void CLOP_1718_Test() throws Exception {
		...
		Chrome_Driver.get("https://metadatadev.clo.edmesh.com/taggingtool/chapters/sn_2cb");
		Thread.sleep(10000);
		...
		for (int i=1;i<=rowCount;i++) {
			...
			if(sValue.equalsIgnoreCase("Photosynthesis 2")){
				Assert.assertEquals("https://metadatadev.clo.edmesh.com/img/content-browser/cloitem.jpg", Chrome_Driver.findElement(By.xpath("//*[@id='project-overview']/div[1]/a["+i+"]/div/img")).getAttribute("src"));
	        }
			if(sValue.equalsIgnoreCase("Blink")){
				Assert.assertEquals("https://metadatadev.clo.edmesh.com/img/content-browser/contentitem.jpg", Chrome_Driver.findElement(By.xpath("//*[@id='project-overview']/div[1]/a["+i+"]/div/img")).getAttribute("src"));
	        }
		}
		...
		Assert.assertEquals("https://metadatadev.clo.edmesh.com/img/content-browser/concept.png", Chrome_Driver.findElement(By.xpath("//*[@id='chapterHierarchy']/ul/li/ul/li[1]/div/img")).getAttribute("src"));
		...
		Assert.assertEquals("https://metadatadev.clo.edmesh.com/img/content-browser/model.png", Chrome_Driver.findElement(By.xpath("//*[@id='chapterHierarchy']/ul/li/ul/li[2]/div/img")).getAttribute("src"));
		...
		Assert.assertEquals("https://metadatadev.clo.edmesh.com/img/content-browser/practice.png", Chrome_Driver.findElement(By.xpath("//*[@id='chapterHierarchy']/ul/li/ul/li[3]/div/img")).getAttribute("src"));
		...
		Assert.assertEquals("https://metadatadev.clo.edmesh.com/img/content-browser/assessment.png", Chrome_Driver.findElement(By.xpath("//*[@id='chapterHierarchy']/ul/li/ul/li[6]/div/img")).getAttribute("src"));
