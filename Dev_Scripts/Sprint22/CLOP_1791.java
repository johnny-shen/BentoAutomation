...
public class CLOP_1791 {
	...
	public void CLOP_1791_Test() throws Exception {
		...
		Chrome_Driver.get("https://metadatadev.clo.edmesh.com/taggingtool/chapter/sn_5353/137c0031451f49399700a2236792ce07");
		Thread.sleep(10000);
		...
		Assert.assertEquals("MathJax-Element-2", Chrome_Driver.findElement(By.xpath("//*[@id='content-preview']/div/script")).getAttribute("id"));
