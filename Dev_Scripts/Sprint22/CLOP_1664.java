...
public class CLOP_1664 {
	...
	public void CLOP_1664_Test() throws Exception {
		...
		Assert.assertEquals("https://metadatadev.clo.edmesh.com/img/preloader_ani4.gif", Chrome_Driver.findElement(By.xpath("//*[@id='loading']/div/img")).getAttribute("src"));
		...
		Assert.assertEquals("https://metadatadev.clo.edmesh.com/img/preloader_ani4.gif", Chrome_Driver.findElement(By.xpath("//*[@id='waiting']")).getAttribute("src"));
		Assert.assertEquals("Please Wait...", Chrome_Driver.findElement(By.xpath("//*[@id='pleasewait']")).getAttribute("innerText"));
