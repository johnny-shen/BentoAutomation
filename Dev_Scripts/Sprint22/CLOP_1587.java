...
public class CLOP_1587 {
	...
	public void CLOP_1587_Test() throws Exception {
		...
		Thread.sleep(5000);
		List<WebElement> AllSearchResults=Chrome_Driver.findElements(By.xpath("//*[@id='metadatatable']/tbody/tr"));
		int size = AllSearchResults.size();
		...
		Thread.sleep(5000);
		Chrome_Driver.findElement(By.xpath("//*[@id='chapterHierarchy']/ul/li/ul/li[3]/a")).click();
		Thread.sleep(5000);	
