...
public class CLOP_1660 {
	...
	public void CLOP_1660_Test() throws Exception {
		...
		Chrome_Driver.get("https://metadatadev.cloqa.edmesh.com/learning-objectives/");
		Assert.assertEquals("Advanced Search", Chrome_Driver.findElement(By.xpath("//*[@id='advancedsearchlink']")).getText());
		Thread.sleep(3000);
		Chrome_Driver.findElement(By.xpath("//*[@id='mainlogo']")).click();
		Thread.sleep(2000);
		Chrome_Driver.get("https://metadatadev.cloqa.edmesh.com/taggingtool/");
		Assert.assertEquals("Advanced Search", Chrome_Driver.findElement(By.xpath("//*[@id='advancedsearchlink']")).getText());
		Thread.sleep(3000);
		Chrome_Driver.findElement(By.xpath("//*[@id='mainlogo']")).click();
		Thread.sleep(2000);
		Chrome_Driver.get("https://metadatadev.cloqa.edmesh.com/metadata-import/");
		Assert.assertEquals("Advanced Search", Chrome_Driver.findElement(By.xpath("//*[@id='advancedsearchlink']")).getText());
		Thread.sleep(3000);
