...
public class CLOP_2128 {
	...
	public void CLOP_2128_Test() throws Exception {
		...
		Assert.assertEquals("https://metadatadev.cloqa.edmesh.com/img/registration/bento-logo.png", Chrome_Driver.findElement(By.xpath("//*[@class='row application-banner application-banner-bento']/img")).getAttribute("src"));
		...
		for  (WebElement eachResult : AllSearchResults) {
			...
			if(sValue.equalsIgnoreCase("https://metadatadev.cloqa.edmesh.com/learning-objectives/")){
				LO = "true";
	        }
			if(sValue.equalsIgnoreCase("http://academicbenchmarks.com/")){
				AB = "true";
	        }			
			if(sValue.equalsIgnoreCase("https://metadatadev.cloqa.edmesh.com/taggingtool/")){
				CB = "true";
	        }
		}
