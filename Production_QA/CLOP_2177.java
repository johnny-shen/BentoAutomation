...
public class CLOP_2177 {

	@Test
	public void CLOP_2177_Test() throws Exception {
		...
		// Validate the Bento Issue Reporting page and Contents.
		...
		Assert.assertEquals("Summary", Chrome_Driver.findElement(By.xpath("//*[@id='issue-summary']")).getAttribute("placeholder"));
		Assert.assertEquals("Description", Chrome_Driver.findElement(By.xpath("//*[@for='issue-description']")).getText());
		Assert.assertEquals("Description", Chrome_Driver.findElement(By.xpath("//*[@id='issue-description']")).getAttribute("placeholder"));
		Assert.assertEquals("Priority", Chrome_Driver.findElement(By.xpath("//*[@for='issue-priority']")).getText());
		Assert.assertEquals("1-Urgent\n2-Very High\n3-High\n4-Medium\n5-Low", Chrome_Driver.findElement(By.xpath("//*[@id='issue-priority']")).getText());		
		...
		for  (WebElement eachResult : AllSearchResults) {
			...
			if (sValue.equalsIgnoreCase("https://metadatadev.cloqa.edmesh.com/img/home/nav-icon-content-browser.png")) {
				eachResult.click();
				Thread.sleep(5000);
				break;
			}
