...
public class CLOP_1639 {
	...
	public void CLOP_1639_Test() throws Exception {
		...
		Thread.sleep(3000);		
		menu = Chrome_Driver.findElement(By.xpath("//*[@id='chapterHierarchy']/ul/li/ul/li[2]/ul/li[1]/a"));
		builder = new  Actions(Chrome_Driver);
		builder.moveToElement(menu).build().perform();
		...
		Thread.sleep(4000);
		Assert.assertEquals("Widget", Chrome_Driver.findElement(By.xpath("//*[@id='chapterHierarchy']/ul/li/ul/li[2]/ul/li[1]/a")).getAttribute("data-type"));
