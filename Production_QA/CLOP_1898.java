...
public class CLOP_1898 {
	...
	public void CLOP_1898_Test() throws Exception {
		...
		Assert.assertEquals("https://metadatadev.cloqa.edmesh.com/img/registration/bento-logo.png", Chrome_Driver.findElement(By.xpath("//*[@class='bento-logo-container']/img")).getAttribute("src"));
		Assert.assertEquals("url(https://metadatadev.cloqa.edmesh.com/img/registration/login-background-1-blur.jpg)", Chrome_Driver.findElement(By.xpath("//*[@id='UserLoginForm']")).getCssValue("background-image"));
